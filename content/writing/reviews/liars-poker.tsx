...
const LiarsPoker: React.FC = () => {
  return (
    <article>
      <p>I wouldn't read this again, but it put Michael Lewis out there, and the world (and Hollywood) has benefited from that. It makes me want to write a book, and it should be required reading for any finance person.</p>
    </article>
  );
};
