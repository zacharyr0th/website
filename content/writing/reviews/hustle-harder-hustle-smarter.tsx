...
const HustleHarderHustleSmarter: React.FC = () => {
  return (
    <article>
      <p>I started this after finishing a few financial books that burnt me out. This was a good in-between book, but I didn't take much away from it. I also skipped around because it was getting repetitive.</p>

      <p>Then my burnt-out factor wore off - so I was ready to move on to a new book.</p>

      <p>I recommend reading this one if you like 50 or know nothing about him, but it's in no way required reading. It's a kind of self-help book. Fun fact: my uncle produced a movie that starred 50 Cent.</p>
