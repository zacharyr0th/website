...
export const metadata: ContentItem = {
  ...
  imageCaption: 'Book cover of The Sovereign Individual by James Dale Davidson and William Rees-Mogg',
  pageViews: 0,
  type: 'review',
  description: 'A critical review of The Sovereign Individual and its predictions about technology and society.',
  content: '', 
  author: 'Zachary Roth',
  bookAuthor: 'James Dale Davidson and William Rees-Mogg',
  date: 'Jun 2023',
  tags: ['Technology', 'Society', 'Futurism'],
  readTime: 6,
  likes: 0,
  comments: 0,
  shares: 0,
