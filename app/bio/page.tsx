...
const TimelineItem: React.FC<TimelineItemProps> = ({ item, index }) => (
  <div 
    className="relative pl-8 animate-fadeIn" 
...
const BioPage = () => {
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: 'var(--color-background)', fontFamily: 'var(--font-family-base)' }}>
      <main className="flex-grow container mx-auto px-5 md:px-48 pt-32 md:pt-36 pb-8 md:pb-18 max-w-5xl">
        {/* Hero Section */}
        <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
          <ProfileImage />
          <div className="text-center md:text-left">
            <h1 style={{ color: 'var(--heading-color)' }} className="text-4xl font-bold mb-2">Zachary Roth</h1>
            <p style={{ color: 'var(--color-text-primary)' }} className="text-xl mb-1">Technologist, Writer, & Musician</p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <Section>
            <h2 className="text-2xl font-bold mb-6 dark:text-white" style={{ color: 'var(--heading-color)' }}>Experience</h2>
          ...
          {/* Skills section */}
          <Section>
            <h2 className="text-2xl font-bold mb-6 dark:text-white" style={{ color: 'var(--heading-color)' }}>Skills</h2>
