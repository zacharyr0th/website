...
import { ROUTES, SITE_INFO, SECURITY } from '@/lib';
...
export async function GET() {
  try {
    ...
    const projectRoutes = PROJECTS
      .filter(project => project.status !== PROJECT_STATUS.WIP)
      .map(project => ({
    ...
    const allRoutes = [...staticRoutes, ...articleRoutes, ...projectRoutes, ...resourceRoutes]
