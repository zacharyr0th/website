...
const ProjectTag = ({ tag }: ProjectTagProps) => (
  <span className="inline-flex items-center px-3 py-1 text-sm text-[var(--color-text-secondary)] bg-[rgba(255,255,255,0.1)] rounded-xl">
    {tag}
  </span>
);
        ...
        <div className="flex h-full flex-col justify-between space-y-4">
          <div className="space-y-2">
            <div className="flex items-start justify-between">
              <h3 className="text-xl font-semibold text-[var(--color-text-primary)] group-hover:text-accent transition-colors">
                {project.title}
              </h3>
