          ...
          {[
            {
              ...
              description: 'Exploring the potential of blockchain technology in the gaming industry.',
              link: 'https://example.com/blockchain-gaming',
            },
            {
              title: 'Building a Minimalist OS from Scratch',
              description: 'A deep dive into the process of creating a simple operating system.',
              link: 'https://example.com/minimalist-os',
            },
            {
              title: 'Privacy-First DeFi: The Next Frontier',
              description: 'Examining the importance of privacy in decentralized finance.',
