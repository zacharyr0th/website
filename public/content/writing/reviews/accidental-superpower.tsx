    ...
    <article>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              <a href="/writing/accidental-superpower">The Accidental Superpower</a>
            </td>
            <td>How the USA found itself in such a dominant position</td>
          </tr>
          <tr>
            <td>
              <a href="/writing/absent-superpower">The Absent Superpower</a>
            </td>
            <td>
          ...
          <tr>
            <td>
              <a href="/writing/disunited-nations">Disunited Nations</a>
            </td>
            <td>
          ...
          <tr>
            <td>
              <a href="/writing/eotwijtb">The End of the World is Just the Beginning</a>
            </td>
