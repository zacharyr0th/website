...
const BornStandingUp: React.FC = () => {
  return (
    <article>
      ...
      <p>
        As the author and narrator of the audiobook, Steve leads you through the various stages of
        his life in a very empathetic way. He wasn't always a legend, and he's clear about that so
        its interesting listening to the entire arc where he went from being a nobody to being the
