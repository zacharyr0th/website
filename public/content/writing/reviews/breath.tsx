...
const Breath: React.FC = () => {
  return (
    <article>
      ...
      <p>
        James Nestor found out why and went above and beyond to explain the importance of nose
        breathing. it doesn't make sense as to why modern medical science isn't more focused on
        this. I've never heard about it from a teacher or doctor, even though there is so much
        proven value in breathing correctly. This book details the disastrous effects of mouth
        breathing and does a great job of scaring you into caring. The TLDR is - every time you
        breathe through your mouth, you're breathing inferior air than if you were to breathe
        through your nose, and you will probably die sooner.
      </p>
      <p>
        The first book by James Nestor,{' '}
        <Link href="/content/writing/reviews/deep">
          <a>Deep</a>
        </Link>
