...
const DeepWork: React.FC = () => {
  return (
    <article>
      ...
      <p>
        The thesis is to reduce your dependence on technology and multitasking while working because
        it's making you less productive. When this topic comes up, I just think about the attention
        span that people had 100 years ago compared to today. If you're reading this, you're
        probably on your phone right now, and that's fine. It's all about the quality of one's
        screen time rather than quantity now because of how ubiquitous screens have become although
        they've been proven to make one's brain lazier just by being near them.
      </p>
      <p>Do with that what you will.</p>
      <h3>Newport's Rules for Deep Work</h3>
      <p>
      ...
      <p>
        Cal gives out a lot of advice, and there are Deep Work laybooks and analyses are available
        online if you're interested in implementing some of it. I wasn't that ambitious about it.
      </p>
    </article>
  );
};
