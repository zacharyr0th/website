...
NounsDAO is an ambitious NFT project going to Mint One Noun Every Day Forever. After 103 days, these Nouns’ sale prices are averaging well above 100 ETH, and each signifies entrance into NounsDAO. Smart contracts govern the entire project, and 100% of every sale is deposited into the community’s treasury, which at the time of writing holds over 14,456 ETH, or $69,388,800. That’s an average revenue stream and profit of $673,677.67 per day. Good luck finding any startup with those numbers.
...
Pablo Picasso
Such is the case for many DeFi protocols, as they are often forked versions of each other with attempted enhancements. Forking can enable unprecedented levels of innovation, but it can also allow bad actors to make nefarious platforms very easily, especially on blockchains with low fees like Binance Smart Chain (BSC). Forks ultimately provoke competition and help instill a constant need for projects to stay on their toes rather than become complacent.

An infamous example of a forked project is SushiSwap. During the DeFi Summer of 2020, Uniswap had been the go-to DEX for most people as its daily volume surpassed Coinbase. A competitor called SushiSwap came along and forked the project while adding an enhanced incentivizing reward system through their issue of SUSHI tokens.
